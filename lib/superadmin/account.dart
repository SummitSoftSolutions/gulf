...
class Accounts extends StatefulWidget {
  ...
  final bool isAdmin;
  final String id;
  const Accounts({super.key,required this.firstname, required this.id, required this.isAdmin,});
                                    ...
                                    child: const Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Center(child: Text('ACCOUNT MASTER',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                                        ],
                                      ),
                                    )
                                    ...
                                    child: const Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          // ),
                                          const SizedBox(height: 25,),
                                          Center(child: Text('GROUP MASTER',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                                        ],
                                      ),
                                    )
                                  // Adjust the height as needed
