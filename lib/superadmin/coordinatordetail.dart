...
import 'package:gulf_suprabhaatham/superadmin/adminViewallreceipt.dart';
...
import 'Account_masterpage.dart';
import 'coordinator_viewadmin.dart';
...
class CoordinatorDetailPage extends StatefulWidget {
  ...
  final bool isAdmin;
  final String id;
  const CoordinatorDetailPage({super.key,required this.firstname, required this.id, required this.isAdmin,});

  @override
  State<CoordinatorDetailPage> createState() => _CoordinatorDetailPageState();
}

class _CoordinatorDetailPageState extends State<CoordinatorDetailPage> {
  @override
  void initState() {
    super.initState();
    getApiurl();
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(title:   const Padding(
          ...
          child: Text('COORDINATORS',style: TextStyle(color: Colors.white),),
                                  ...
                                  child: const Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Center(child: Text('COORDINATOR',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                                      ],
                                    ),
                                  )
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                Navigator.pushAndRemoveUntil(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) =>  CoordinatorViewAdmin(firstname:widget.firstname,id:widget.id,isAdmin:widget.isAdmin)),
                                      (Route<dynamic> route) =>
                                    ...
                                    child: const Padding(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Center(child: Text('VIEW RECEIPT',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                                        ],
                                      ),
                                    )
                                  // Adjust the height as needed
