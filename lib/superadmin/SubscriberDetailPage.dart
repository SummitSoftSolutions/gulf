...
import '../agent/commityCreation.dart';
import '../agent/coordinatorlogin.dart';
import '../agent/subscription_creation.dart';
...
class SubscriberDetailPage extends StatefulWidget {
  ...
  final bool isAdmin;
  final String id;
  const SubscriberDetailPage({super.key,required this.firstname, required this.id, required this.isAdmin,});
                                  ...
                                  child: const Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Center(child: Text('ADD SUBSCRIPTION',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                                      ],
                                    ),
                                  )
                                // Adjust the height as needed
                          ...
                          children: [
                                  ...
                                  child: const Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Center(child: Text('ADD COMMITTEE',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                                      ],
                                    ),
                                  )
                                // Adjust the height as needed
                            ...
                            GestureDetector(
                                onTap: () {
                                  Navigator.push(context,
                                      MaterialPageRoute(builder: (context) {
                                        return  CommityCreation(firstname:widget.firstname,id:widget.id,isAdmin:widget.isAdmin);
                                      }));
                                },child: const Icon(Icons.arrow_forward_ios_rounded,
                                color:Colors.grey))
                            // SizedBox(width: 10,),
