...
import '../agent/coordinator_reciptview.dart';
import '../agent/coordinatorlogin.dart';
import '../agent/reciept_form.dart';

class ReceiptPageData extends StatefulWidget {

  final String firstname;
  final bool isAdmin;
  final String id;
  const ReceiptPageData({super.key,required this.firstname, required this.id, required this.isAdmin,});

  @override
  State<ReceiptPageData> createState() => _ReceiptPageDataState();
}

class _ReceiptPageDataState extends State<ReceiptPageData> {
  @override
  void initState() {
    super.initState();
    getApiurl();
                                  ...
                                  child: const Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Center(child: Text('ADD RECEIPT',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                                      ],
                                    ),
                                  )
                            ...
                            GestureDetector(
                              onTap: () {
                                ...
                                Navigator.pushAndRemoveUntil(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          ReceiptForm(firstname:widget.firstname,id:widget.id,isAdmin:widget.isAdmin)),
                                      (Route<dynamic> route) =>
